...
The goal of asystentWymiany is to ...

Installation
------------

You can install the released version of asystentWymiany from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("asystentWymiany")
```
